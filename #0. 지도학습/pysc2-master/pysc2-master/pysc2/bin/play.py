...
flags.DEFINE_string("replay", "C:\\Program Files (x86)\\StarCraft II\\Replays\\TerranAgent\\Simple64_2020-03-25-05-39-19.SC2Replay", "Name of a replay to show.")
...
def main(unused_argv):
  ...
  with run_config.start(
    ...
    if FLAGS.map:
      ...
      print(info)
      print("Map path :", info.local_map_path)
      print(" Replay info ".center(60, "-"))
      print(info.player_info.race_actual)
      print(type(info.player_info[0].player_info.race_actual), info.player_info[0].player_info.race_actual)
      print(type(info.player_info[0].player_info.race_requested), info.player_info[0].player_info.race_requested)
      print(info.player_info[0].player_info.race_actual)
      if info.player_info[0].player_info.race_actual != "Terran":
...
if __name__ == "__main__":
  read_dir = "C:\\Program Files (x86)\\StarCraft II\\Maps\\Melee\\"
