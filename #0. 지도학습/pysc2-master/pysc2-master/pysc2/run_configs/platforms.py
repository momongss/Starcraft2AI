...
class LocalBase(lib.RunConfig):
  ...
  def get_versions(self, containing=None):
    ...
    print('VERSION_DIR', versions_dir)
    version_prefix = "Base"
    ...
    print('FOUND VERSION', versions_found)
    print("VERSION TYPE", type(known_versions[0]))
    known_versions.append('4.0.2')
    known_versions.append('3.16.1')
