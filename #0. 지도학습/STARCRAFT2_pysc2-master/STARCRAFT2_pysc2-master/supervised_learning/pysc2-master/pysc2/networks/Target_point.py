...
def target_point_encoder(autoregressive_embedding, action_type, map_skip):
    ...
    screen1_logits = keras.layers.Reshape((128, 128))(screen1_logits)
    ...
    screen2_logits = keras.layers.Reshape((128, 128))(screen2_logits)
...
if __name__ == '__main__':
    target_point_encoder(autoregressive_embedding, action_type, map_skip)