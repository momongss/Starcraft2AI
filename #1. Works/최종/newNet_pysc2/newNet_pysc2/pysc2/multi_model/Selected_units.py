...
def selected_units_encoder(autoregressive_embedding, action_type, entity_list):
    ...
    selected_units_encoder_model = models.Model(inputs=[autoregressive_embedding,
                                                        action_type,
                                                        entity_list],
                                                outputs={'selected_unit_logits': selected_unit_logits})

    return selected_units_encoder_model
