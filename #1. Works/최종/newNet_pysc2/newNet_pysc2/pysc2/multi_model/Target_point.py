...
def target_point_encoder(autoregressive_embedding, action_type, map_skip):
    ...
    target_point_encoder_model = models.Model(inputs=[autoregressive_embedding,
                                                      action_type,
                                                      map_skip],
                                              outputs={'minimap_logits': minimap_logits,
                                                       'screen1_logits': screen1_logits,
                                                       'screen2_logits': screen2_logits},
                                              name='spatial_encoder')
    return target_point_encoder_model
