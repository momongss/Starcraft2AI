...
point_flag.DEFINE_point("window_size", "1280,960",
...
# flags.DEFINE_string("replay", "C:\\Users\\rkrp1\\Desktop\\종합설계\\#5. 리플레이\\target\\0.SC2Replay", "Name of a replay to show.")
...
def main(unused_argv):
  ...
  with run_config.start(
    ...
    if FLAGS.map:
      ...
      # if info.player_info[0].player_info.race_actual != 1 or info.player_info[0].player_mmr < 1000:
      ...
      try:
        ...
        while True:
          ...
          if obs.actions:
              ...
              func = func_call.function.real
          agent.small_update_play(func, agent_obs)
          save_point += 1

          agent.LSTM1.save_weights('./checkpoints/LSTM1/sc_checkpoint')
          agent.LSTM2.save_weights('./checkpoints/LSTM2/sc_checkpoint')
          agent.LSTM3.save_weights('./checkpoints/LSTM3/sc_checkpoint')
          './ checkpoints / LSTM1 / small_checkpoint'

          agent.BI_LSTM1.save_weights('./checkpoints/BI_LSTM1/sc_checkpoint')
          agent.BI_LSTM2.save_weights('./checkpoints/BI_LSTM2/sc_checkpoint')
          agent.BI_LSTM3.save_weights('./checkpoints/BI_LSTM3/sc_checkpoint')
...
if __name__ == "__main__":
  read_dir = '/home/ubuntu/capstone_design/collecting_data/data/4.0.2/target/'
