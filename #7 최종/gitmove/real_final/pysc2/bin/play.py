...
flags.DEFINE_string("replay", "C:\\Users\\rkrp1\\Desktop\\종합설계\\# 리플레이 만들기\\-_2.SC2Replay", "Name of a replay to show.")
# flags.DEFINE_string("replay", "C:\\Program Files (x86)\\StarCraft II\\Replays\\ModelAgent\\Simple64_2020-05-03-07-57-23.SC2Replay", "Name of a replay to show.")
      ...
      try:
        ...
        while True:
          ...
          if func != 0:
              ...
              replay_save[agent_obs['game_loop']] = [func, args]
