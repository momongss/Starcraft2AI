...
def action_type_encoder(lstm_output, scalar_context):
    ...
    gate = layers.Dense(conv_width, activation='sigmoid', kernel_regularizer=tf.keras.regularizers.l1(0.01),
                        activity_regularizer=tf.keras.regularizers.l2(0.01))(scalar_context)
