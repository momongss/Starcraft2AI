...
from pysc2.small_network import LSTM2
from pysc2.small_network import LSTM3

from pysc2.small_network import BI_LSTM1
from pysc2.small_network import BI_LSTM2
from pysc2.small_network import BI_LSTM3
...
class BaseAgent(object):
  ...
  def __init__(self):
    ...
    self.h_state = np.zeros((1, 384))
    self.c_state = np.zeros((1, 384))

    self.update_count = 0
    self.delay_count = 0

    self.startcraft = total_model()
    # print('모델 로드 성공')
