...
class ModelAgent(base_agent.BaseAgent):
    def model_update_play(self, action, arg, obs):
        ...
        self.prev_state = network_output[9]
    ...
    def model_predict_play(self, available_action, obs):
        ...
        if actionID == 0:  # [(4,), (500,)]
            ...
            arg = [(arg1,), (arg2,)]
            return action, arg
        if actionID == 1:  # [(128, 128)], minimap : 6
            arg = np.unravel_index(network_output[6].argmax(), network_output[6].shape)
            return action, arg
        if actionID == 2:  # [(2,), (128, 128)], screen1 : 7
            arg1 = np.argmax(Queue)
            arg2 = np.unravel_index(network_output[7].argmax(), network_output[7].shape)
            arg = [(arg1,), arg2]
            return action, arg
        if actionID == 3:  # [(2,), (128, 128)], minimap : 6
            arg1 = np.argmax(Queue)
            arg2 = np.unravel_index(network_output[6].argmax(), network_output[6].shape)
            arg = [(arg1,), arg2]
            return action, arg
        ...
        if actionID == 5:  # [(2,)]
            ...
            arg = [(arg1,)]
            return action, arg
        if actionID == 6:  # [(4,), (128, 128)], screen2 : 7
            arg1 = np.argmax(Target_Unit[:4])
            arg2 = np.unravel_index(network_output[7].argmax(), network_output[7].shape)
            arg = [(arg1,), arg2]
            return action, arg
        ...
        if actionID == 9:  # [(5,), (10,)]
            ...
            arg = [(arg1,), (arg2,)]
            return action, arg
        if actionID == 10:  # [(2,), (128, 128), (128, 128)], screen1 : 7, screen2 : 8
            arg1 = np.argmax(Queue)
            arg2 = np.unravel_index(network_output[7].argmax(), network_output[7].shape)
