    ...
    if FLAGS.render:
      ...
      try:
        ...
        while True:
          ...
          agent.startcraft_model.save('sc_model.h5')
          et = time.time()
          print("전체 시간", et - st)
          if obs.player_result:
            agent.startcraft_model.save('sc_model')
            break
...
if __name__ == "__main__":
  FLAGS.replay = '/home/ubuntu/capstone_design/collecting_data/data/target/target.SC2Replay'
  app.run(main)
